...
def run(X,y,initial_u1,initial_u2,rho_term,noise_term,baseline_indices,psi_indices,user_id_index,user_mat=None,first_mat=None):
    ...
    kernel = GPy.kern.CustomKernelMore(len(baseline_indices),baseline_indices=baseline_indices,psi_indices=psi_indices,user_index=user_id_index,initial_u1=initial_u1,initial_u2=initial_u2,initial_rho=rho_term,initial_noise=noise_term,user_mat=user_mat,first_mat = first_mat)
