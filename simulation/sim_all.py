...
def initialize_policy_params_TS(experiment,update_period,\
    ...
    if algo_type=='pooling_four':
        ...
        u_params =[0.0553,0.0467,0.0052,0.0098,0.9030,1,0.5410,1,0.4680,1] #[0.06451840481880405,0.01370354099136279,0.010851198582671185,0.015391588363759446,0.725637691598818,1.227441604469287,0.9107303216615658,0.9863941781916185,1.3498034928863532,0.5768819568022332]
    ...
    for case in cases:
        ...
        for u in [update_time]:
            ...
            for sim in range(sim_start,sim_end):
                ...
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_four_effects_new_coeff.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim)
