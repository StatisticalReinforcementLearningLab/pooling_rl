...
#[0.0466,0.0324,0.0068,0.0043,1.7509,1.7855,1.6397,1.8128,1.6484,1.6648]
    ##next try
    ...
    for case in cases:
        ...
        for u in [update_time]:
            ...
            for sim in range(sim_start,sim_end):
                ...
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_location_7_20_npfhs.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim)
