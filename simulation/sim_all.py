    ...
    for case in cases:
        ...
        for u in [update_time]:
            ...
            for sim in range(sim_start,sim_end):
                ...
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_424_difstarts_opfourrsnoupdates.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim)
