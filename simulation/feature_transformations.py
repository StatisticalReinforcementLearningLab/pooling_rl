...
class feature_transformation:
        ...
        def __init__(self,root):
            ...
            with open('{}dists_base_4_4.pkl'.format(root),'rb') as f:
                self.dists = pickle.load(f)

            with open('{}key_matches_base_4_4.pkl'.format(root),'rb') as f:
                self.matched = pickle.load(f)


            with open('{}dists_anti_sedentary_4_4.pkl'.format(root),'rb') as f:
                self.dists_intervention_anti_sedentary = pickle.load(f)

            with open('{}key_matches_anti_sedentary_4_4.pkl'.format(root),'rb') as f:
                self.matched_intervention_anti_sedentary = pickle.load(f)


            with open('{}dists_activity_suggestion_4_4.pkl'.format(root),'rb') as f:
                self.dists_intervention_activity_suggestion = pickle.load(f)

            with open('{}key_matches_activity_suggestion_4_4.pkl'.format(root),'rb') as f:
