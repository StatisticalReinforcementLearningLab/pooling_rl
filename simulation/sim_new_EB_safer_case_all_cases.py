        ...
        if time==experiment.last_update_day+pd.DateOffset(days=global_policy_params.update_period):
            ...
            if global_policy_params.decision_times>200:
                ...
                try:
                    ...
                    print(e)
                    temp_params={'cov':global_policy_params.cov,'sigma_u':global_policy_params.sigma_u,'noise':global_policy_params.noise_term,\
                        'like':-100333
}
                ...
                print('global_info', time,global_policy_params.decision_times,temp_params['noise'],time_module.strftime('%l:%M%p %Z on %b %d, %Y'),temp_params['like'],file=open('../../murphy_lab/lab/pooling/{}_two/updates_case_three_global_{}_{}_{}.txt'.format(case,len(experiment.population),global_policy_params.update_period,sim_num), 'a'))
        ...
        for person in experiment.dates_to_people[time]:
                ...
                if time in participant.decision_times:
                    ...
                    if availability:
                        ...
                        print('p_info', time,global_policy_params.decision_times,time_module.strftime('%l:%M%p %Z on %b %d, %Y'),participant.pid,action,steps,participant.gid,file=open('../../murphy_lab/lab/pooling/{}_two/updates_case_three_participant_{}_{}_{}.txt'.format(case,len(experiment.population),global_policy_params.update_period,sim_num), 'a'))
                    else:
                        #participant.steps_last_time_period = participant.steps
