...
def new_kind_of_simulation(experiment,policy=None,personal_policy_params=None,global_policy_params=None,feat_trans=None):
    ...
    for time in experiment.study_days:
        ...
        if time==experiment.last_update_day+pd.DateOffset(days=global_policy_params.update_period):
            ...
            print('Global update', time,global_policy_params.decision_times,time_module.strftime('%l:%M%p %Z on %b %d, %Y'),file=open('outs/updates_batch_baseline_EB_{}_{}_six_weeks_only.txt'.format(len(experiment.population),global_policy_params.update_period), 'a'))
...
if __name__=="__main__":
    ...
    #     pickle.dump(to_Save,f)
            ...
            filename = '{}/results/population_size_batch_baseline_EB_{}_update_days_{}_{}_batch_{}_{}_new_params_six_weeks_only.pkl'.format('pooling',pop_size,update_time,study_length,case,i)
            with open(filename,'wb') as f:
