                        ...
                        if algo_type=='pooling':
                            ...
                            #print(temp_data[0].shape)
                                ...
                                if temp_params['cov'] is not None:
                                    ...
                                    global_policy_params.lr = global_policy_params.lr/5
    ...
    for case in cases:
        ...
        for u in [update_time]:
            ...
            for sim in range(sim_start,sim_end):
                ...
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_4_24fancyoptlnoise.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim)
