...
import run_gpytorchkernel_noEBlarger
import operator
import study
...
def initialize_policy_params_TS(experiment,update_period,\
    ...
    if algo_type=='pooling_four':
        ...
        #u_params = [0.0471,0.0301,0.0071,0.0074,1.8545,1.7990,1.7400,1.8092,1.7457,1.7105]
        u_params =[0.0466,0.0324,0.0068,0.0043,1.7509,1.7855,1.6397,1.8128,1.6484,1.6648]
#[0.0553,0.0467,0.0052,0.0098,0.9030,1,0.5410,1,0.4680,1] #[0.06451840481880405,0.01370354099136279,0.010851198582671185,0.015391588363759446,0.725637691598818,1.227441604469287,0.9107303216615658,0.9863941781916185,1.3498034928863532,0.5768819568022332]
    ...
    for case in cases:
        ...
        for u in [update_time]:
            ...
            for sim in range(sim_start,sim_end):
                ...
                filename = '{}{}/population_size_{}_update_days_{}_{}_static_sim_{}_location_7_20_np.pkl'.format('{}{}/'.format(write_directory,algo_type),case,pop_size,u,'short',sim)
